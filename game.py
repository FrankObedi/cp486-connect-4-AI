...
def show_possible_moves(possible_moves, board):
    '''
...
def select_move(possible_moves, board, selection):
    '''
    ...
    '''
    show_possible_moves(possible_moves, board)
...
def drop_puck(move, player, board):
    '''
...
def is_winning_move(player, move, board):
    '''
...
if __name__ == "__main__":
    ...
    while winner == None:
        ...
        print()
        print(f"--{player}--")
        move = select_move(possible_moves, board)

        if is_winning_move(player, move, board):
            print(f'Player {player} wins!!!')
            winner = player
            board[move.row][move.col].player = player
            display_board()
        else:
            drop_puck(move, player, board)
